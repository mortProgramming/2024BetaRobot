...
public class ClimberControl extends Command {
  ...
  public void execute() {
    ...
    // if (climber.getLeftClimberMotor().getPosition().getValueAsDouble() <= LEFT_CLIMBER_MIN && leftMotorValue < 0){
    //     leftMotorValue = 0;

    // } else if (climber.getLeftClimberMotor().getPosition().getValueAsDouble() >= LEFT_CLIMBER_MAX && leftMotorValue > 0){
    //     leftMotorValue = 0;
    // }

    // if (climber.getRightClimberMotor().getPosition().getValueAsDouble() >= RIGHT_CLIMBER_MIN && rightMotorValue > 0){
    //     rightMotorValue = 0;
    // } else if (climber.getRightClimberMotor().getPosition().getValueAsDouble() <= RIGHT_CLIMBER_MAX && rightMotorValue < 0){
    //     rightMotorValue = 0;
    // }
    ...
    climber.setMotor(leftMotorValue, rightMotorValue);
